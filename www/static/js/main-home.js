...
const searchBar = document.querySelector('.search_container-home');
const searchInstance = new GeneralSearch (searchBar,{
    ...
    productsTemplateFunction: (result) => {
        return `
                <div class="" style="margin-right: 18px; position: relative; margin-bottom: 18px;">
                <a href="../../shop/products/${result.product.product.id}" style="display: block; width: 100%; height: 100%; position: absolute; z-index:100;"></a>
        <div class="product-img" style="width: 172px; height: 172px; background-color: var(--grey); position: relative;">
            <span></span>
            ...
            <div class="product-title">
                <div class="product_price-container">
                    <div class="product-price">
                        ...
                        <p style="margin: 0px; font-size: 14px; font-weight: 500; font-size: 10px;">${result.product.name}</p>
                        <p style="margin: 0px; font-size: 16px; font-weight: 600; font-size: 14px;">${result.product.product.name}</p>
                        <p style="margin: 0px; font-size: 12px;">per ${result.unit.unit} (${result.unit.unitAbbr}.)</p>
                    </div>
                </div>
    `
    },
    pagesTemplateFunction: (result) => {
